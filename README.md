...
* [X] List anything else that you can get done to improve the functionality!
	-Set placeholders in text boxes to remind users of input format
	-Set limits on input length to increase security & set the realistic standard use of calculator

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/b6WyeeW.gifv' title='Video Walkthrough' width='' alt='Video Walkthrough' />
